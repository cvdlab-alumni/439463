...
ParticleEngine2.prototype.setValues = function( parameters )
{
...
ParticleEngine2.prototype.randomValue = function(base, spread)
{
	return base + spread * (Math.random() - 0.5);
}
ParticleEngine2.prototype.randomVector3 = function(base, spread)
{
...
ParticleEngine2.prototype.createParticle = function()
{
...
ParticleEngine2.prototype.initialize = function()
{
	...
	House.add( this.particleMesh );
}

ParticleEngine2.prototype.update = function(dt)
{
	var recycleIndices = [];
